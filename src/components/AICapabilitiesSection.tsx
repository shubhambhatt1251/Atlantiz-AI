...
const AICapabilitiesSection = () => {
  return (
    <section className="w-full pt-0 pb-8 sm:pb-12 bg-gradient-to-br from-white via-pulse-50/20 to-white relative overflow-hidden scroll-offset-navbar" id="details">
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 animate-on-scroll pt-72 sm:pt-80 md:pt-96 pb-8">
          <h2 className="text-3xl sm:text-4xl font-display font-bold tracking-tight mb-3 sm:mb-4 bg-gradient-to-r from-gray-900 via-pulse-600 to-gray-900 bg-clip-text text-transparent animate-text-shimmer mt-36 sm:mt-40 md:mt-44 leading-tight pt-4 pb-4">
